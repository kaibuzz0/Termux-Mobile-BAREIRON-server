 ...
 * NPC survivors with classes, behaviors, and trading.
 * The Witch — a roaming boss with dark magic.
 * Rare retro hero easter eggs.
 * 
 * Memory-conscious design: No pathfinding, no complex AI.
 * NPCs stand guard, follow players, or trade simple goods.
 */
...
typedef struct {
    ...
    int summons_total;
    int defeated;
    int achievement_unlocked;  // Has any player gotten the achievement?
} WitchBoss;
...
void spawn_npc(int village_id, NPCClass class, float x, float z);
...
const char* get_npc_class_name(NPCClass class);
const char* get_npc_greeting(NPCClass class, int familiarity);

// ═══════════════════════════════════════════════════════════
// FUNCTIONS — TRADING
// ═══════════════════════════════════════════════════════════

void init_trading_system();
...
// Check if a chunk contains a village
int chunk_has_village(int chunk_x, int chunk_z);

// Get village at location
Village* get_village_at(int x, int z);
